      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link text-light" href="createuser.php">
              <i class="fa fa-user" aria-hidden="true"></i>
                Create User
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-light" href="transfermoney.php">
                <i class="fa fa-lg fa-exchange" aria-hidden="true"></i>
                Transfer Money
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link text-light" href="transactionhistory.php">
